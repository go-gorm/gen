...
type CreditCard struct {
	...
	CustomerRefer *int64         `gorm:"column:customer_refer;index:fk_customers_credit_cards,priority:1" json:"-"`
	BankID        *int64         `gorm:"column:bank_id;index:fk_credit_cards_bank,priority:1" json:"-"`
}
